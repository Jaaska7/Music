...
import com.example.appmusicandroid.Util.MacUsuari
...
class CurrentActivity : AppCompatActivity() {
    ...
    private lateinit var macUsuari: MacUsuari
...
//        val macAddress = macUsuari.obtenirMacAddress(this)
//        val macAddressTextView: TextView = findViewById(R.id.macAdress)
